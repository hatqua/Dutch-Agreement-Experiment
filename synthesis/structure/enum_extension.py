...
class EnumExtension(Enum):
	"""
	This enum extends Python's Enum by defining a number of functions that operate on descendants of this enum. There is currently only one single function in this enum.
	"""
	@classmethod
	def find(cls, value):
		"""
		This class returns the enum member that is associated with the given value.
		"""
